...
background = pygame.image.load("lab8/raceAssets/Street.png")
...
class Enemy(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("lab8/raceAssets/car2.png")
...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("lab8/raceAssets/car1.png")
        self.rect = self.image.get_rect()
...
class Coin(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("lab8/raceAssets/coin.png")
        self.rect = self.image.get_rect()
...
while not done:
    ...
    if pygame.sprite.spritecollideany(P1, enemies):
        pygame.mixer.Sound("lab8/raceAssets/crash.wav")
        time.sleep(1)
