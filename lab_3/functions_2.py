...
#2
def above_5_5_movies(movies_list):
    return [movie for movie in movies_list if is_above_5_5(movie)]
...
#Usage:
print(is_above_5_5(movies[0]))  #1
print(above_5_5_movies(movies))  #2
print(movies_by_category(movies, "Romance"))  #3
print(average_imdb_score(movies))  #4
print(average_imdb_score_by_category(movies, "Suspense"))  #5